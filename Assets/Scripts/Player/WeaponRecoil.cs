...
namespace RainbowCube.Player
{
    public class WeaponRecoil : MonoBehaviour
    {
        ...
        [Space(10)] [Header("Speed Settings:")]
        ...
        public Vector3 RecoilKickBack = new Vector3(0.015f, 0f, -0.0f);
        ...
        public void Fire()
        {
            ...
            {
                rotationalRecoil += new Vector3(-RecoilRotation.x, Random.Range(-RecoilRotation.y, RecoilRotation.y),
